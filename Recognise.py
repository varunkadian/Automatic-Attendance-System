...
start = time.time()
period = 30
face_cas = cv2.CascadeClassifier('C:/Users/shrad/AppData/Local/Programs/Python/Python310/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
cap = cv2.VideoCapture(0);
recognizer = cv2.face.LBPHFaceRecognizer_create();
recognizer.read('C:/Users/shrad/Documents/Durham College/Semester 2/Capstone 2/Project/trainer/trainer.yml');
flag = 0;
id = 0;
filename = 'filename';
dict = {
